...
TOKEN_META = "EAH5107Jgp0EBRaqGE5aOgVxPVK9c09DNeT8IJ43mZBv0TDRl8HZAvZApDHmTAE54YoMg5WNZBCnW3X0LIuuIzGr3e7RZAv2cTVIJ0th3XwOdCJyOzcZBYZA8uEKFlSQQdmmeUSZBZCZCBLr2xdhJpupA51mnvZAgGfInGVJXZCsvUSf3fD6X81rBQUA6fgZBLImA0lvL1hgZDZD"
                ...
                for index, Secretária in df_agrupado.iterrows():
                    ...
                    if telefone_formatado and len(telefone_formatado) >= 10:
                        ...
                        if code == 200 or code == 201:
                            ...
                            erros += 1
                            # Retorna estritamente o erro real bruto recebido da Meta ou do Python
